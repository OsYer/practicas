        ...
        mostrar(vehiculo) {
            return new Promise((resolve) => {
                ...
                formDiv.append("button")
                    ...
                    .on("click", () => {
                    const vehiculoActualizado = Object.assign(Object.assign({}, vehiculo), { Placa: placaInput.node().value, CargaMaxima: parseInt(cargaMaximaInput.node().value), Estado: estadoSelect.node().value, UnidadCarga: unidadCargaSelect.node().value, TipoCarga: tipoCargaSelect.node().value, Activo: true });
                    fetch(Nm_Vehiculos.URL_BASE + "/ServicioVehiculos.svc/ActualizarVehiculo", {
                        method: "PUT",
                        ...
                        .then(success => {
                        if (success === true) {
                            Nm_Vehiculos.mostrarNotificacion("✅ Vehículo actualizado correctamente");
                            formDiv.remove();
