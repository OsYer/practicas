var N_Mascotas;
(function (N_Mascotas) {
    function editarMascota(mascota, onGuardar) {
        ...
        campos.forEach(campo => {
            ...
            form.append("input")
                ...
                .property("value", mascota[campo.nombre])
                .style("width", "100%")
                .style("padding", "5px")
        ...
        form.append("button")
            ...
            const actualizada = Object.assign(Object.assign({}, mascota), inputs);
    ...
    N_Mascotas.editarMascota = editarMascota;
